...
testimonieApp.controller('EditionController', ['$scope', '$routeParams', 'Page',
    function ($scope, $routeParams, Page) {
        ...
        var leftImage = document.getElementById('pageLeft');
        ...
        function getCoords(purl){
            ...
            split = split[1].split(',');
            var widthMult = leftImage.clientWidth/1981;
	        //var imgWidth = 496/1981;
            coords.x = parseInt(split[0])*widthMult;
            coords.y = parseInt(split[1])*widthMult;
            coords.w = parseInt(split[2])*widthMult;
            coords.h = parseInt(split[3])*widthMult;
            return coords;
        }
